...
[Read more on preparing 5.1 mixes for Apple Spatial playback here]({{< relref "posts/previewing-spatial-audio-on-apple" >}})
[Read more on the limitations seen when using Dolby Atmos for mixing here]({{< relref "posts/observations-and-limitations-of-dolby-atmos-for-spatial-mixing" >}})
